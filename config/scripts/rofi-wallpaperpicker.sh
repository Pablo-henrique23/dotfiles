...
# Set some variables
wall_dir="${HOME}/Imagens/Wallpapers/OneMonitor/"
cacheDir="${HOME}/.cache/jp/${theme}"
rofi_command="rofi -x11 -dmenu -theme ${HOME}/.config/rofi/config.rasi -theme-str ${rofi_override}"
...
swww img "${wall_dir}/${wall_selection}" --transition-step 20 --transition-fps 20
